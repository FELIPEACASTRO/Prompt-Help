...
O conteúdo está dividido em duas categorias principais para facilitar a busca:

| Pasta | Conteúdo | Foco |
| :--- | :--- | :--- |
| `Prompts/` | Prompts prontos para uso, estruturados em Markdown. | **Ação Imediata** |
| `Recursos_e_Ferramentas/` | Catálogos de Mega Libraries, Guias Oficiais, Repositórios GitHub e Ferramentas Open-Source. | **Pesquisa e Estudo** |

### 2. Como Navegar e Encontrar o Prompt Desejado

Para encontrar o que você precisa, siga a estrutura de pastas dentro de `Prompts/`:

| Subpasta | Descrição | Exemplo de Uso |
| :--- | :--- | :--- |
...
O arquivo **`Recursos_e_Ferramentas.md`** é o ponto de partida para quem busca conhecimento aprofundado, consolidando:

*   **Mega Libraries:** Coleções com mais de 30.000 prompts.
*   **Guias Oficiais:** Documentação de produção da OpenAI, Anthropic, Google e Microsoft.
*   **Ferramentas Open-Source:** Frameworks como LangChain, Agenta e ChainForge.
*   **Documentação Técnica:** Prompts especializados para *Technical Writers* e apresentações executivas.
...
The content is divided into two main categories to facilitate searching:

| Folder | Content | Focus |
| :--- | :--- | :--- |
| `Prompts/` | Ready-to-use prompts, structured in Markdown. | **Immediate Action** |
| `Recursos_e_Ferramentas/` | Catalogs of Mega Libraries, Official Guides, GitHub Repositories, and Open-Source Tools. | **Research and Study** |

### 2. How to Navigate and Find the Desired Prompt

To find what you need, follow the folder structure within `Prompts/`:

| Subfolder | Description | Example Usage |
| :--- | :--- | :--- |
...
The **`Recursos_e_Ferramentas.md`** file is the starting point for those seeking in-depth knowledge, consolidating:

*   **Mega Libraries:** Collections with over 30,000 prompts.
